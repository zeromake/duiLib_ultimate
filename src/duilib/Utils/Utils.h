...
namespace DuiLib
{
	...
	//////////////////////////////////////////////////////////////////////////////////////
	//
	static char* w2a(wchar_t* lpszSrc, UINT   CodePage = CP_DEFAULT)
	{
		if (lpszSrc != NULL)
		{
	...
	static wchar_t* a2w(char* lpszSrc, UINT   CodePage = CP_DEFAULT)
	{
		if (lpszSrc != NULL)
		{
    ...
    static wchar_t* a2w(LPCTSTR lpszSrc, UINT CodePage = CP_DEFAULT)
	{
#ifdef UNICODE
        return (wchar_t*)lpszSrc;
#else
