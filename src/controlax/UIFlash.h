...
namespace DuiLib
{
	//	, public IOleInPlaceSiteWindowless // 透明模式绘图，需要实现这个接口1
	class UILIB_API CFlashUI : public CActiveXUI, public _IShockwaveFlashEvents, public ITranslateAccelerator
	{
