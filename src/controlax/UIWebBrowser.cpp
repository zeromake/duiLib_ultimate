...
#define __DEFINE_GUID(name, l, w1, w2, b1, b2, b3, b4, b5, b6, b7, b8) \
        EXTERN_C const GUID DECLSPEC_SELECTANY name \
                = { l, w1, w2, { b1, b2,  b3,  b4,  b5,  b6,  b7,  b8 } }

__DEFINE_GUID(__IID_IDownloadManager, 0x988934a4, 0x064b, 0x11d3, 0xbb, 0x80, 0x0, 0x10, 0x4b, 0x35, 0xe7, 0xf9);

__DEFINE_GUID(__CGID_DocHostCommandHandler, 0xf38bc242,0xb950,0x11d1,0x89,0x18,0x00,0xc0,0x4f,0xc2,0xc8,0x36);

__DEFINE_GUID(__IID_ICustomDoc, 0x3050f3f0, 0x98b5, 0x11cf,0xbb, 0x82, 0, 0xaa, 0, 0xbd, 0xce, 0xb);
...
namespace DuiLib
{
	...
	void CWebBrowserUI::NavigateComplete2( IDispatch *pDisp,VARIANT *&url )
	{
		...
		if (spDoc) {
            ...
            spDoc->QueryInterface(__IID_ICustomDoc, (void**)&spCustomDoc);
			if (spCustomDoc)
	...
	void CWebBrowserUI::NavigateUrl( LPCTSTR lpszUrl )
	{
		...
		{
			m_pWebBrowser2->Navigate((BSTR)SysAllocString(a2w(lpszUrl)),NULL,NULL,NULL,NULL);
		}
	}
	...
	STDMETHODIMP CWebBrowserUI::QueryService( REFGUID guidService, REFIID riid, void** ppvObject )
	{
		...
		*ppvObject = NULL;
		...
		if ( guidService == __IID_IDownloadManager && riid == __IID_IDownloadManager)
		{
			*ppvObject = this;
			return S_OK;
		}
	...
	IDispatch* CWebBrowserUI::GetHtmlWindow()
	{
		...
		IHTMLDocument2* pHtmlDoc2 = (IHTMLDocument2*)pDp;
	...
	HRESULT STDMETHODCALLTYPE CWebBrowserUI::Exec( __RPC__in_opt const GUID *pguidCmdGroup, DWORD nCmdID, DWORD nCmdexecopt, __RPC__in_opt VARIANT *pvaIn, __RPC__inout_opt VARIANT *pvaOut )
	{
		...
		if (pguidCmdGroup && IsEqualGUID(*pguidCmdGroup, __CGID_DocHostCommandHandler))
		{
