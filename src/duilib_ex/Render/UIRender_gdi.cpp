...
namespace DuiLib {
    ...
    void UIRender_gdi::DrawBitmapHDC(HDC hCloneDC,
        const RECT& rc,
        const RECT& rcPaint,
		...
		BYTE uFade, bool hole, bool xtiled, bool ytiled)
	{
        ...
        DrawBitmapHDC(hCloneDC, rc, rcPaint, rcBmpPart, rcCorners, bAlpha, uFade, hole, xtiled, ytiled);
