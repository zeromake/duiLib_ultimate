...
namespace DuiLib {
	...
	public:
        ...
        bool DrawImage(HBITMAP bitmap, int width, int height, bool bAlpha=false, BYTE uFade=255);
        bool DrawImageHDC(HDC dc, RECT rcBmpPart);
		...
		// 客户区域（除去scrollbar和inset和内边距）
        virtual RECT GetClientInlinePos() const;
        ...
        virtual void SetInlinePadding(RECT rcPadding);
        virtual RECT GetInlinePadding() const;
