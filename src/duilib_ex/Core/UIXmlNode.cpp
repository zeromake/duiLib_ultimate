...
{
	return (LPCTSTR)impxmlnode(_root).name();
}

LPCTSTR CXmlNodeUI::value() const
{
	return (LPCTSTR)impxmlnode(_root).value();
}
...
{
	return CXmlNodeUI(impxmlnode(_root).child((ui_pugi::char_t*)name).internal_object());
}

CXmlAttributeUI CXmlNodeUI::attribute(LPCTSTR name) const
{
	return CXmlAttributeUI(impxmlnode(_root).attribute((ui_pugi::char_t*)name).internal_object());
}

CXmlNodeUI CXmlNodeUI::next_sibling(LPCTSTR name) const
{
	return CXmlNodeUI(impxmlnode(_root).next_sibling((ui_pugi::char_t*)name).internal_object());
}

CXmlNodeUI CXmlNodeUI::previous_sibling(LPCTSTR name) const
{
	return CXmlNodeUI(impxmlnode(_root).previous_sibling((ui_pugi::char_t*)name).internal_object());
}
...
{
	return impxmlnode(_root).set_name((ui_pugi::char_t*)rhs);
}

bool CXmlNodeUI::set_value(LPCTSTR rhs)
{
	return impxmlnode(_root).set_value((ui_pugi::char_t*)rhs);
}

CXmlAttributeUI CXmlNodeUI::append_attribute(LPCTSTR name)
{
	return CXmlAttributeUI(impxmlnode(_root).append_attribute((ui_pugi::char_t*)name).internal_object());
}

CXmlAttributeUI CXmlNodeUI::prepend_attribute(LPCTSTR name)
{
	return CXmlAttributeUI(impxmlnode(_root).prepend_attribute((ui_pugi::char_t*)name).internal_object());
}

CXmlAttributeUI CXmlNodeUI::insert_attribute_after(LPCTSTR name, const CXmlAttributeUI& attr)
{
	return CXmlAttributeUI(impxmlnode(_root).insert_attribute_after((ui_pugi::char_t*)name, ui_pugi::xml_attribute((ui_pugi::xml_attribute_struct *)attr.internal_object())).internal_object());
}

CXmlAttributeUI CXmlNodeUI::insert_attribute_before(LPCTSTR name, const CXmlAttributeUI& attr)
{
	return CXmlAttributeUI(impxmlnode(_root).insert_attribute_before((ui_pugi::char_t*)name, ui_pugi::xml_attribute((ui_pugi::xml_attribute_struct *)attr.internal_object())).internal_object());
}
...
{
	return CXmlNodeUI(impxmlnode(_root).append_child((ui_pugi::char_t*)name).internal_object());
}

CXmlNodeUI CXmlNodeUI::prepend_child(LPCTSTR name)
{
	return CXmlNodeUI(impxmlnode(_root).prepend_child((ui_pugi::char_t*)name).internal_object());
}

CXmlNodeUI CXmlNodeUI::insert_child_after(LPCTSTR name, const CXmlNodeUI& node)
{
	return CXmlNodeUI(impxmlnode(_root).insert_child_after((ui_pugi::char_t*)name, ui_pugi::xml_node((ui_pugi::xml_node_struct *)node.internal_object())).internal_object());
}

CXmlNodeUI CXmlNodeUI::insert_child_before(LPCTSTR name, const CXmlNodeUI& node)
{
	return CXmlNodeUI(impxmlnode(_root).insert_child_before((ui_pugi::char_t*)name, ui_pugi::xml_node((ui_pugi::xml_node_struct *)node.internal_object())).internal_object());
}
...
{
	return impxmlnode(_root).remove_attribute((ui_pugi::char_t*)name);
}
...
{
	return impxmlnode(_root).remove_child((ui_pugi::char_t*)name);
}
