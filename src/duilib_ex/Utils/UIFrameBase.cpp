...
DUI_BEGIN_MESSAGE_MAP(CUIFrmBase,CNotifyPump)
	...
	DUI_ON_MSGTYPE(DUI_MSGTYPE_ACCEPTFILE,	OnNotifyAcceptFile)	//(_T("selectchanged"))
	...
	DUI_ON_MSGTYPE(DUI_MSGTYPE_STARTSELCHANGE,	OnNotifyStartSelChange)
	DUI_ON_MSGTYPE(DUI_MSGTYPE_ENDSELCHANGE,	OnNotifyEndSelChange)
