...
namespace DuiLib
{
	...
	void CVerticalLayoutUI::DoPostPaint(UIRender *pRender, const RECT& rcPaint)
	{
	...
	bool CVerticalLayoutUI::CalcPos(CControlUI *pChildControl, RECT &rcChild) //子控件调用这个，计算子空间的rect
	{
