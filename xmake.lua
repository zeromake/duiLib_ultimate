...
target("sokol-cube")
    set_kind("binary")
    add_options("utf8", "application")
    add_files("./demo/sokol-d3d11/d3d11entry.c")
    add_files("./demo/sokol-d3d11/cube-d3d11.c")

target("sokol-texcube")
    set_kind("binary")
    add_options("utf8", "application")
    add_files("./demo/sokol-d3d11/d3d11entry.c")
    add_files("./demo/sokol-d3d11/texcube-d3d11.c")

target("sokol-triangle")
    set_kind("binary")
    add_options("utf8", "application")
    add_files("./demo/sokol-d3d11/d3d11entry.c")
    add_files("./demo/sokol-d3d11/triangle-d3d11.c")
...
target("winrt-demo")
    ...
    add_options("utf8", "application")
    set_pcxxheader("./demo/winrt-demo/pch.h")
    add_files("./demo/winrt-demo/*.cpp")
